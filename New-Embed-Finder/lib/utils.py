...
def make_embed(group_info):
    return dict(
      title="Scrapped Claimable Group",
        fields=[
         dict(name="**Main Group Info**", 
value=f"**Name**: `{group_info['name']}`\n**MemberCount**: `{group_info['memberCount']}`\n**Robux**:  `Not Visible`\n\n"),
        ...
        author=dict(
          name="RoFind",
          icon_url="https://cdn.discordapp.com/attachments/882931299558518796/900324097890856970/standard_6.gif"
        ),
       color=random.randint(10000, 50000),
      
        footer=dict(
            text="RoFind | Made by regorela and S_waraj",
          icon_url='https://cdn.discordapp.com/attachments/882931299558518796/900324097890856970/standard_6.gif'
        ),
     thumbnail=dict(url='https://cdn.discordapp.com/attachments/882931299558518796/900324097890856970/standard_6.gif')
    )
